...
var lock = new Auth0Lock({
    clientId: '4ZoVxGUVM5bFO0PA8C6xk409IbRl6JO0',
    domain: 'maillard.auth0.com'
});
        ...
        if (this.props.title === 'Gallery') {
            ...
            function deletePhoto() {
                ...
                fetch(myServerURL + '/photo/' + this.id, {
                    ...
                    .then(function(response) {
                        if (response.ok) {
                            alert('Delete Your Photo');
                        } else {
                            alert('There was a problem deleting your photo')
